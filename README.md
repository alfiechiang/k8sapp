...
k8sapp: Simple Single Golang Web Service

go-crud正式改名为k8sapp!

使用k8sapp开发Web服务: 用最简单的架构，实现够用的框架，服务海量用户

https://github.com/Gourouting/k8sapp
...
k8sapp框架为移动端提供Token登录的案例: https://github.com/bydmm/k8sapp-token-exmaple
## 目的
